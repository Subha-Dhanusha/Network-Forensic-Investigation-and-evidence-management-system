...
def generate_report(evidence, output_path: str, generated_by=None):
    styles = _styles()
    ...
    if generated_by is not None:
        generator_line = f"Generated by: {generated_by.username}"
        if getattr(generated_by, "investigator_id", None):
            generator_line += f" ({generated_by.investigator_id})"
        elif getattr(generated_by, "role", None) == "admin":
            generator_line += " (Administrator)"
        story.append(Paragraph(generator_line, styles["Normal"]))
    ...
    summary_data = [
        ["Case Name", case.name],
        ["Case Investigator", case.investigator or "unassigned"],
        ["Report Generated By", (
            f"{generated_by.username} ({generated_by.investigator_id})"
            if generated_by and getattr(generated_by, "investigator_id", None)
            else generated_by.username if generated_by else "unknown"
        )],
