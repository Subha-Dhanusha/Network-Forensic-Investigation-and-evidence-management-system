"""
One-time script: adds @login_required to every route in app/routes.py,
adds a working admin "reset password" action to app/auth.py, and restores
the Reset Password button in app/templates/admin_users.html.

Run this from your project root:
    python apply_login_required_and_reset.py
"""

routes_content = '''import os
import uuid
...
print("app/routes.py written (all routes now @login_required).")

with open("app/auth.py", "w", encoding="utf-8") as f:
    f.write(auth_content)
print("app/auth.py written (reset_user_password added).")

with open("app/templates/admin_users.html", "w", encoding="utf-8") as f:
    f.write(admin_users_html)
print("app/templates/admin_users.html written (Reset Password button restored).")
